...
def add_articles():
    p1 = api_models.Article(photo='asdfasdfasd',
                     title='Искусственный интеллект открывает новые горизонты в медицинской диагностике', 
    ...
    p1 = api_models.Article(photo='adsfasdf',
                     title='Искусственный интеллект закрывает новые горизонты в медицинской диагностике', 
